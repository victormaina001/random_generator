...
def about():
    ...
    r2.iconbitmap("C:/Users/VICTORMAINA/Pictures/naiboi.png")
    mf5=ttk.Frame(r2,padding='3 3 12 12')
    ...
    ttk.Label(l,text="Created By: Victor Maina",foreground="white",background="#19284B",font=("Arial Black",16)).grid(row=2,column=0,columnspan=2)
    img=ImageTk.PhotoImage(Image.open("C:/Users/VICTORMAINA/Pictures/naiboi.png"))
    imglbl=ttk.Label(l,background="#19284B",image=img)
    imglbl.photo=img
    imglbl.grid(row=4,column=0,rowspan=3)
    ttk.Label(l,text="PersonGen",foreground="white",background="#19284B",font=("Calibri",16)).grid(row=4,column=1)
    ...
    ttk.Label(l,text="Email : mainavictor004@gmail.com",foreground="white",background="#19284B",font=("Calibri",14)).grid(row=7,column=1)
    glbl=ttk.Label(l,text="Github : https://github.com/victormaina001",foreground="white",background="#19284B",font=("Calibri",14),cursor="hand1")
    glbl.grid(row=9,column=1)
    glbl.bind('<1>',lambda e: webbrowser.open("https://github.com/victormaina001"))
...
def features():
    ...
    r3.iconbitmap("C:/Users/VICTORMAINA/Pictures/naiboi.png")
...
def export():
    filename.set(filedialog.asksaveasfilename(title="Select Location of File",filetypes=((" Csv files","*.csv"),)))
    file=open(filename.get()+".csv","w")
...
root=Tk()
root.title("PersonGen v1.0.0")
img = PhotoImage(file='C:/Users/VICTORMAINA/Pictures/naiboi.png')
...
ttk.Button(mfl,text="About",command=about).grid(row=4,column=2)
